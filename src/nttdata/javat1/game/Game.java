...
public class Game {
	...
	/**
	 * Inicia el juego imprimiendo el menú de juego
	 * Y solicitará al jugador indicar una opción
	 * del menú
	 */
	...
	/**
	 * Solicitará una respuesta hasta que la misma sea validA.
	 * Según la opción que se elija, se realizará un proceso u otro.
	 */
	...
	/**
	 * Comprueba si el jugador tiene dinero suficiente para realizar
	 * una compra, de ser así, entrará al cajero. De lo contrario
	...
	/**
	 * Solicitará al usuario introducir una cantidad de
	 * fichas para comprar hasta que sea posible realizar
	 * la compra. De lo contrario imprimirá un error y
	...
	/**
	 * Comprueba si el usuario tiene fichas suficientes 
	 * para iniciar un juego nuevo. De ser así, continuará
	 * con el procedimiento de inicio. De lo contrario
	 * imprimirá un mensaje de error.
	 */
	private void executeOptionA() {
		...
		/*Devuelve al menu inicial luego de jugar
		 *o luego de imprimir un error */
		returnToPrincipalMenu();
	}

	/**
	 * Solicitará al jugador introducir una respuesta hasta
	 * que esta sea valida del menú de dificultad. 
	 * Cuando la respuesta sea valida iniciará el juego
	 */
	private void requestAnswerGameMode() {
		...
		} while(!gameModeAnswer.equals("E") && !gameModeAnswer.equals("M") &&
				!gameModeAnswer.equals("H") && !gameModeAnswer.equals("L"));
	}

	/**
	 * Ejecuta un sonido de moneda y deja 3 segundos a
	 * que termine de reproducirse antes de continuar.
	 */
	...
	/**
	 * Solicitará al jugador introducir una apuesta hasta
	 * que sea valida.
	 */
	...
	/**
	 * Deja pasar 5 segundos y devuelve al jugador
	 * al menú principal. A su vez ejecutará un sonido
	 */
	...
	/**
	 * Iniciará un juego y lo configurará según el modo
	 * de juego indicado por parametro. Si la respuesta 
	 * no es valida, imprimirá un error.
	...
	/**
	 * Lanzará las bolas e irá reproduciendo eventos
	 * hasta que se hayan acabado las bolas.
	...
	private void gameDevelopment(List<Ball> b) {
		...
		try {
			/*Detiene el sonido del juego y imprime
			 * los paneles correspondientes indicando
	...
	/**
	 * Generará distintos eventos aleatorios que pueden
	 * ocurrir a una bola. 80% de probabilidad de obtener
	 * un evento positivo. 10% de probabilidad de obtener
	 * un evento negativo. 10% de probabilidad de perder 
	 * la bola
	...
	/**
	 * Ejecutará un sonido de manera infinita hasta que
	 * se le indique que pare.
	...
	/**
	 * Comprueba si el jugador ha ganado o no, según
	 * si ha superado el objetivo de 500 puntos e 
	 * imprimirá un panel indicando el resultado.
	 * Además según corresponda pagará al usuario o no
	 * y actualizará sus estadisticas personales.
	 */
	...
	/**
	 * De manera aleatoria imprimirá un evento 
	 * positivo y sumará los puntos correspondientes
	 */
	...
	/**
	 * Añade la cantidad de bolas indicada por parametro
	 * a la lista de bolas con las que se jugará
	...
	public static String printNotMoney() {
		StringBuffer sb = new StringBuffer();
	...
	public static String printNoTokens() {
		StringBuffer sb = new StringBuffer();
	...
	public static String printNoValidAnswer() {
		StringBuffer sb = new StringBuffer();
	...
	/**
	 * Comprueba si es posible comprar la cantidad de tokens
	 * indicada por parametro. De ser posible realizará la compra,
	 * ejecutará un sonido e imprimirá un mensaje de compra
	 * realizada con éxito. De lo contrario imprimirá un error
	...
	/**
	 * Comprueba si la cantidad de tokens solicitados
	 * para comprar, son un número positivo y si el
	 * jugador posee dinero suficiente para su compra
	 * @param amountTokens La cantidad de tokens a comprar
	 * @return True en caso de ser posible comprar esa cantidad 
	...
	/**
	 * Imprime un mensaje de que la bola lanzada se ha
	 * perdido y indica cuantas bolas quedan restantes
	...
	/**
	 * Imprime un mensaje de Game Over junto a la
	 * ejecución de un sonido representante del mismo
	 */
	...
	/**
	 * Imprime un mensaje indicando el modo de juego seleccionado,
	 * la cantidad de bolas con las que se jugará, el como
	 * se desarrollará el juego y el objetivo a cumplir para
	 * poder ganar
	 */
	...
	/**
	 * Imprime el panel inicial del juego con las
	...
	/**
	 * Imprime un menú de apuesta, donde se solicitará
	 * al jugador indicar cuantos tokens quiere apostar
	 */
